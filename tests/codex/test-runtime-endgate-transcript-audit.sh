...
IMPORTED_EXPLORE_NEGATIVE_FIXTURE="$REPO_ROOT/tests/codex/fixtures/runtime-prose-endgate-imported-explore-skill-negative.jsonl"
...
assert_file_exists "$IMPORTED_EXPLORE_NEGATIVE_FIXTURE" "imported-explore negative runtime prose-endgate fixture exists"
...
assert_audit_fails_with_mode "$IMPORTED_EXPLORE_NEGATIVE_FIXTURE" "missing canonical carrier" "imported-explore incident fixture is rejected when strict packet mode loses the canonical carrier"
