...
assert_section_contains "skills/using-superpowers/SKILL.md" "## Autonomous Continuation" 'endgate-state-packet.*post-packet event window|earlier same-turn tool calls do not satisfy a later `endgate-state-packet`' "global contract documents packet-first endgate boundaries and last-packet scope" '^## '
...
assert_section_contains "skills/brainstorming/SKILL.md" "## Presenting the design:" 'endgate-state-packet.*post-packet event window|earlier same-turn tool calls do not satisfy a later `endgate-state-packet`' "brainstorming documents packet-first checkpoint boundaries and last-packet scope" '^## '
...
assert_section_contains "skills/writing-plans/SKILL.md" "## Execution Handoff" 'endgate-state-packet.*post-packet event window|earlier same-turn tool calls do not satisfy a later `endgate-state-packet`' "writing-plans documents packet-first execution handoff boundaries and last-packet scope" '^## '
assert_section_contains "skills/writing-plans/SKILL.md" "## Execution Handoff" 'Every execution handoff in this repository uses `endgate-state-packet`|每个 execution handoff.*必须.*endgate-state-packet' "writing-plans makes strict packet mode explicit instead of optional" '^## '
...
assert_section_contains "skills/executing-plans/SKILL.md" "## The Process" 'endgate-state-packet.*post-packet event window|earlier same-turn tool calls do not satisfy a later `endgate-state-packet`' "executing-plans documents packet-first routine boundaries and last-packet scope" '^## '
assert_section_contains "skills/executing-plans/SKILL.md" "## The Process" 'Every routine boundary in this repository uses `endgate-state-packet`|每个 routine boundary.*必须.*endgate-state-packet' "executing-plans makes strict packet mode explicit instead of optional" '^## '
...
assert_section_contains "skills/subagent-driven-development/SKILL.md" "## The Process" 'Every reviewed-task boundary in this repository uses `endgate-state-packet`|每个 reviewed-task boundary.*必须.*endgate-state-packet' "subagent-driven-development makes strict packet mode explicit instead of optional" '^## '
...
assert_section_contains "skills/spec-governed-development/SKILL.md" "## Handoff Guidance" 'endgate-state-packet.*post-packet event window|earlier same-turn tool calls do not satisfy a later `endgate-state-packet`' "spec-governed-development documents packet-first governance handoff boundaries and last-packet scope" '^## '
assert_section_contains "skills/spec-governed-development/SKILL.md" "## Handoff Guidance" 'Every governance handoff in this repository uses `endgate-state-packet`|每个治理 handoff.*必须.*endgate-state-packet' "spec-governed-development makes strict packet mode explicit instead of optional" '^## '
