...
assert_section_contains "skills/finishing-a-development-branch/SKILL.md" "#### Option 4: Discard" 'Use a two-stage destructive confirmation state machine: a numbered choice first, then a lettered confirmation step\.' "finishing flow documents two-stage destructive confirmation" '^(###|####) '
assert_section_contains "skills/finishing-a-development-branch/SKILL.md" "#### Option 4: Discard" '1\. Continue to the final discard confirmation step' "finishing flow Stage 1 includes the continue option text" '^(###|####) '
assert_section_contains "skills/finishing-a-development-branch/SKILL.md" "#### Option 4: Discard" '2\. Go back' "finishing flow Stage 1 includes the go back option text" '^(###|####) '
assert_section_contains "skills/finishing-a-development-branch/SKILL.md" "#### Option 4: Discard" '3\. Review impact' "finishing flow Stage 1 includes the review impact option text" '^(###|####) '
...
assert_section_contains "skills/finishing-a-development-branch/SKILL.md" "#### Option 4: Discard" 'a\. Confirm discard now' "finishing flow Stage 2 includes the confirm option text" '^(###|####) '
assert_section_contains "skills/finishing-a-development-branch/SKILL.md" "#### Option 4: Discard" 'b\. Review impact again' "finishing flow Stage 2 includes the review option text" '^(###|####) '
assert_section_contains "skills/finishing-a-development-branch/SKILL.md" "#### Option 4: Discard" 'c\. Cancel' "finishing flow Stage 2 includes the cancel option text" '^(###|####) '
assert_section_contains "skills/finishing-a-development-branch/SKILL.md" "#### Option 4: Discard" 'Text fallback for Stage 2: Reply with `a`, `b`, or `c`\.' "finishing flow uses lettered a/b/c options for the second destructive stage" '^(###|####) '
assert_section_contains "skills/finishing-a-development-branch/SKILL.md" "#### Option 4: Discard" 'If Stage 2 `a` is chosen:' "finishing flow exposes a single explicit execution entry point" '^(###|####) '
...
assert_section_contains "skills/finishing-a-development-branch/SKILL.md" "#### Option 4: Discard" 'Review impact requested from Stage 1 returns to Stage 1, and review impact requested from Stage 2 returns to Stage 2\.' "review impact returns to the correct confirmation layer" '^(###|####) '
assert_section_contains "skills/finishing-a-development-branch/SKILL.md" "#### Option 4: Discard" 'Choosing `go back` in Stage 1 or `cancel` in Stage 2 returns to the parent flow; if there is no parent flow, it safely ends the destructive subflow without making changes\.' "go back and cancel safely exit the destructive subflow" '^(###|####) '
