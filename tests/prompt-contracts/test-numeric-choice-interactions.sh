...
assert_not_contains "skills/finishing-a-development-branch/SKILL.md" "Type 'discard' to confirm\\." "finishing flow no longer defaults to typed discard confirmation"
